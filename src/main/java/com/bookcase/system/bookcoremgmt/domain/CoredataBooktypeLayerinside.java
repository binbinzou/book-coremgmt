...
/**
 * The persistent class for the coredata_booktype_layerinside database table.
 * 
 */
@Entity
@Table(name="coredata_booktype_layerinside")
@NamedQuery(name="CoredataBooktypeLayerinside.findAll", query="SELECT c FROM CoredataBooktypeLayerinside c")
public class CoredataBooktypeLayerinside implements Serializable {
	...
	public CoredataBooktypeLayerinside() {
	}
